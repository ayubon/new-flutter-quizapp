...
class ThirdRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('How do you input a name?'),
      ),
      body: Center(
          child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          ElevatedButton(
            ...
            child: const Text('Move all items back'),
          ),
          ElevatedButton(
            onPressed: () {
              Navigator.push(
            ...
            child: const Text('Copy to new array'),
          )
        ],
      )),
    );
...
class FourthRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('What pointers need to change?'),
      ),
      body: Center(
          child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text('Just one before'),
          )
        ],
      )),
    );
